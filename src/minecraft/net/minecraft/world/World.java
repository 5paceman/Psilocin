...
public abstract class World implements IBlockAccess
{
    ...
    public void playAuxSFXAtEntity(EntityPlayer player, int sfxType, BlockPos pos, int p_180498_4_)
    {
        ...
        {
            CrashReport crashreport = CrashReport.makeCrashReport(throwable, "Playing level eventsystem");
            CrashReportCategory crashreportcategory = crashreport.makeCategory("Level eventsystem being played");
