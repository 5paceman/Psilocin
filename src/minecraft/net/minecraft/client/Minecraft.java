...
import me.spaceman.psilocin.hooks.PsyGuiIngame;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Psilocin.getInstance();
        Psilocin.getInstance().setup();
        this.ingameGUI = new PsyGuiIngame(this);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        Psilocin.getInstance().getEventHandler().callEvent(new KeyPressEvent(k, Keyboard.getEventKeyState()));
