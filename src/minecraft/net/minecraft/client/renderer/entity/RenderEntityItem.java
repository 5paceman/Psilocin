...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        final RenderDroppedItemEvent.Pre event = new RenderDroppedItemEvent.Pre(entity, x, y, z, entityYaw, partialTicks);
        ...
        final RenderDroppedItemEvent.Post postEvent = new RenderDroppedItemEvent.Post(entity, x, y, z, entityYaw, partialTicks);
        Psilocin.getInstance().getEventHandler().callEvent(postEvent);
    }
