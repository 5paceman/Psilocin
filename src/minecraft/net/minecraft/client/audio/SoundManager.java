                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            logger.debug(LOG_MARKER, "Playing sound {} for eventsystem {} as channel {}", new Object[] {soundpoolentry.getSoundPoolEntryLocation(), soundeventaccessorcomposite.getSoundEventLocation(), s});
