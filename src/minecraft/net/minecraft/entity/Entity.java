...
public abstract class Entity implements ICommandSender
{
    ...
    /**
     * The distance that has to be exceeded in order to triger a new step sound and an onEntityWalking eventsystem on a block
     */
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && (this.isSneaking() || Psilocin.getInstance().getModuleHandler().getModule(Safestep.class).isEnabled()) && this instanceof EntityPlayer;
