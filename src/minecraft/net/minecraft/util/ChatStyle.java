...
public class ChatStyle
{
    ...
    /**
     * The effective chat click eventsystem.
     */
    public ClickEvent getChatClickEvent()
    {
    ...
    /**
     * The effective chat hover eventsystem.
     */
    public HoverEvent getChatHoverEvent()
    {
    ...
    /**
     * Sets the eventsystem that should be run when text of this ChatStyle is clicked on.
     */
    public ChatStyle setChatClickEvent(ClickEvent event)
    {
    ...
    /**
     * Sets the eventsystem that should be run when text of this ChatStyle is hovered over.
     */
    public ChatStyle setChatHoverEvent(HoverEvent event)
    {
